...
function ClickableTick({ x = 0, y = 0, payload, nameToTopic, onSelect }: TickProps) {
  ...
  const clickable = !!(topic && onSelect);
  return (
    <text
      x={x}
      y={y}
      ...
      onClick={clickable ? () => onSelect!(topic!) : undefined}
  ...
  return (
    <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-5 backdrop-blur-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="text-sm font-semibold text-gray-100 tracking-wide">Sentiment by Topic</div>
