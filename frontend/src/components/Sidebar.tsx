...
const NAV_ITEMS: NavItem[] = [
  ...
  {
    id: "geo-intel", tab: "overview", label: "Geo Intelligence",
    icon: <NavIcon d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />,
  },
  {
  ...
  {
    id: "response-studio", tab: "overview", label: "Response Studio",
  ...
  {
    id: "narrative-explorer", tab: "overview", label: "Narrative Explorer",
    icon: <NavIcon d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />,
  },
  {
...
export function Sidebar({ brand, activeTab, onTabChange, onBrandChange, onNavAction, isAdmin, days, customFrom, customTo, showCustom, onDaysChange, onCustomFromChange, onCustomToChange, onCustomToggle }: Props) {
      ...
      <nav className="flex-1 px-2 py-3 space-y-0.5 overflow-y-auto">
        {NAV_ITEMS.filter(item => !item.adminOnly || isAdmin).map(item => {
          ...
          return (
            <button
              key={item.id}
              onClick={() => { if (item.tab) onTabChange(item.tab); onNavAction?.(item.id); }}
